...
Kotlin `HttpSource` (lib **1.4**, `1.4.17`). Display name **R2 Library**. Package stays `eu.kanade.tachiyomi.extension.all.r2merge` so existing installs update.
...
Or sideload `repo/apk/tachiyomi-all.r2merge-v1.4.17.apk`. Settings: account id / access key / secret / bucket.
