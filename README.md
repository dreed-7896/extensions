...
Sideload: [`repo/apk/tachiyomi-all.r2merge-v1.4.17.apk`](repo/apk/tachiyomi-all.r2merge-v1.4.17.apk)

1.4.11 was signed with a throwaway debug cert, so TachiManga hides the update. Uninstall R2 Library, remove the repo, re-add `index.pb`, install **1.4.17**. Later updates keep this key.
